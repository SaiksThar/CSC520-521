...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Property Lost','Property Related Damage','Residential Burglary','Landlord/Tenant Disputes'],'Home Property Related')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Home Property Related']
...
feat_dummies = "Feat_home.joblib"
feat_nodummies = "Feat_home_nodummy.joblib"
