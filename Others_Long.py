...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Other','Violations','Phone Call Complaints','Fire Related Reports','Arson'],'Others')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Others']
...
feat_dummies = "Feat_others.joblib"
feat_nodummies = "Feat_others_nodummy.joblib"
