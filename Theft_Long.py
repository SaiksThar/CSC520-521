...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Property Found','Other Burglary','Recovered Stolen Property','Burglary - No Propety Taken','Commercial Burglary','Larceny'],'Theft')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Theft']
...
# filename = "Theft_lat(updated_noFitTrans).joblib"
