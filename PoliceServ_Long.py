...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Police Service Incidents','Prisoner Related Incident','Search Warrants',
                                                           'Criminal Harassment','Investigate Person','Investigate Property','Warrant Arrests'],'Police Services')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Police Services']
...
feat_dummies = "Feat_police.joblib"
feat_nodummies = "Feat_police_nodummy.joblib"
