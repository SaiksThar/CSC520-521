...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Ballistics','Bomb Hoax','Explosives','Firearm Discovery','Firearm Violations'],'Firearms Related')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Firearms Related']
...
feat_dummies = "Feat_firearms.joblib"
feat_nodummies = "Feat_firearms_nodummy.joblib"
