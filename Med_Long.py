...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Medical Assistance','Drug Violation','Liquor Violation',
                                                           'Operating Under the Influence',],'Medical/Drug/Liquor Related')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Medical/Drug/Liquor Related']
...
feat_dummies = "Feat_med.joblib"
feat_nodummies = "Feat_med_nodummy.joblib"
