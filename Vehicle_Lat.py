...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Motor Vehicle Accident Response','License Plate Related Incidents','Towed','License Violation','Larceny From Motor Vehicle',
                                                           'Aircraft','Auto Theft','Auto Theft Recovery'],'Vehicle related')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Vehicle related']
...
feat_dummies = "Feat_Vehicle.joblib"
feat_nodummies = "Feat_Vehicle_nodummy.joblib"
