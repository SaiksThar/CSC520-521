...
Y['OFFENSE_CODE_GROUP'] = Y['OFFENSE_CODE_GROUP'].replace(['Restraining Order Violations','Service','Vandalism','Evading Fare',
                                                           'Harbor Related Incidents','Assembly or Gathering Violations',
                                                           'Biological Threat'],'Civil Service Violations')

Y = Y[Y.OFFENSE_CODE_GROUP == 'Civil Service Violations']
...
feat_dummies = "Feat_Civil.joblib"
feat_nodummies = "Feat_Civil_nodummy.joblib"
